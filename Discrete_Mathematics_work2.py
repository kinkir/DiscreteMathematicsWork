...
#构建界面
def createWidgets():
	global label1, label2, label3, StringIn, StringO1, StringO2
	...
	label2 = Label(text='主析取范式:',height=3)
	label2.grid(row=7, column=0)
	StringO1 = Label(text='',width=30,relief="ridge")
	StringO1.grid(row=7,column=1,columnspan=3)

	label3 = Label(text='主合取范式:',height=3)
	label3.grid(row=8, column=0)
	StringO2 = Label(text='',width=30,relief="ridge")
	StringO2.grid(row=8,column=1,columnspan=3)
